//En este ejercicio implementamos un método aparte para llamar a las listas y mostrar los resultados 
//por pantalla sin necesidad de hacerlo todo en el main.
...
public class ejercicio26 {
	...
	public static void main(String[] args) {
		...
		MostrarNotas(suspensos, aprobados, notables, excelentes, matricula);
}
	
	public static void MostrarNotas(List<Double> suspensos, List<Double> aprobados, List<Double> notables, List<Double> excelentes, List<Double> matricula ) {
